...
class filterbank_data {
  public:
    ...
    /**
     * new filterbank_data backed by the given `h5_filterbank_file`
     */
    filterbank_data(h5_filterbank_file fb_file);

    /**
     * new filterbank_data backed by the filterbank file at `file_path`
     */
     ...
     *
     * The `coarse_channel` has similar metadata to a `filterbank_data` object
