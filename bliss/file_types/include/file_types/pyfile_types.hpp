...
void bind_pyfile_types(nb::module_ m) {
    ...
    m.def("read_observation_target_hits_from_files", &bliss::read_observation_target_hits_from_files, "file_path"_a);
    m.def("write_cadence_hits_to_files",
          &bliss::write_cadence_hits_to_files,
